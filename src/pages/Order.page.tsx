      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
        <thead>
          <tr style={{ backgroundColor: '#f8f9fa' }}>
            ...
            <th style={{ border: '1px solid #ddd', padding: '12px', textAlign: 'left', fontWeight: 'bold' }}>Tổng giá (Giá gốc)</th> {/* Thêm cột này */}
        ...
        <tbody>
          {currentOrders.map((order) => (
            <tr key={order.id}>
              ...
              <td style={{ border: '1px solid #ddd', padding: '12px' }}>{/* Cần có trường giá gốc trong API response */}Giá gốc</td>
...
const WrappedOrderPage: React.FC = () => {
  ...
  const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoyNCwidXNlcm5hbWUiOiJhZG1pbiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTc0NDI4MjM5OSwiZXhwIjoxNzQ0Mjg1OTk5fQ.ozlpMukRIoNQH5VNunyqehZcj4kFsciFsOkaBAVBbG8';
